(function (global, factory) {
	...
	(factory((global['ngu-utility'] = {}),global.ng.core,global.ng.common));
...
NguLetterAvatarComponent.propDecorators = {
    "alphabetcolors": [{ type: core.Input, args: ["avatar-alphabet-colors",] },],
    "textColor": [{ type: core.Input, args: ["avatar-text-color",] },],
    "defaultBorder": [{ type: core.Input, args: ["avatar-default-border",] },],
    "triangleup": [{ type: core.Input, args: ["avatar-triangle-up",] },],
    "fontsize": [{ type: core.Input, args: ["avatar-font-size",] },],
    "height": [{ type: core.Input, args: ["avatar-height",] },],
    "width": [{ type: core.Input, args: ["avatar-width",] },],
    "fontWeight": [{ type: core.Input, args: ["avatar-font-weight",] },],
    "fontFamily": [{ type: core.Input, args: ["avatar-font-family",] },],
    "radius": [{ type: core.Input, args: ["avatar-radius",] },],
    "dynamic": [{ type: core.Input, args: ["avatar-dynamic",] },],
    "rotatedeg": [{ type: core.Input, args: ["avatar-rotate-degree",] },],
    "charCount": [{ type: core.Input, args: ["avatar-char-count",] },],
    "data": [{ type: core.Input, args: ["avatar-data",] },],
    "avatarBorderStyle": [{ type: core.Input, args: ["avatar-border-style",] },],
    "avatarborder": [{ type: core.Input, args: ["avatar-border",] },],
    "avatarcustomborder": [{ type: core.Input, args: ["avatar-custom-border",] },],
    "shape": [{ type: core.Input, args: ["avatar-shape",] },],
    "avatarcustombgcolor": [{ type: core.Input, args: ["avatar-custom-bg-color",] },],
};
...
//# sourceMappingURL=ngu-utility.umd.js.map
